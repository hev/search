...
//! [`hevsearch_core::VectorKind::Multivector`]:
//!
...
//! ./scripts/cargo test -p hevsearch-core --test manager_multivector \
//!     -- --ignored --nocapture
//! ```
...
use hevsearch_core::{NamespaceId, NamespaceManager, StorageRoot, UpsertRow, VectorKind};
